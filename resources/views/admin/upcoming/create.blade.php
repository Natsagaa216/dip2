        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3>
                        Add Show
                        <a href="{{ url('admin/upcoming') }}"
                           class="btn btn-primary btn-sm text-white float-end">BACK</a>
                    </h3>
                </div>

                <div class="card-body">
                    <form action="{{ url('admin/upcoming') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="name" class="form-control" value="{{ old('show_date') }}">
                                @error('name') <small class="text-danger">{{ $message }}</small> @enderror
                            </div>

                            <div class="col-md-6 mb-3">
                                <label for="name">Show-Time</label>
                                <input type="text" name="name" class="form-control" value="{{ old('show_time') }}">
                                @error('name') <small class="text-danger">{{ $message }}</small> @enderror
                            </div>

                            <div class="col-md-6 mb-3">
                                <label for="name">Venue</label>
                                <input type="text" name="name" class="form-control" value="{{ old('venue') }}">
                                @error('name') <small class="text-danger">{{ $message }}</small> @enderror
                            </div>
